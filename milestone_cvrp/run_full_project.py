...
from baselines import clarke_wright_savings_heuristic, with_two_opt
from cvrp_core import CVRPInstance, evaluate_heuristic, generate_synthetic_benchmarks, nearest_neighbor_heuristic, weighted_greedy_heuristic
from cvrplib_io import load_cvrplib_folder
