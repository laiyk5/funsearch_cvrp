...
from ..cvrp.core import CVRPInstance, evaluate_heuristic, solution_distance, check_capacity_constraint
...
def main() -> None:
    """主函数"""
    # 导入输出管理器
    from ..utils.output_manager import get_output_dir, save_run_info
